...
<namespace_decl>         ::= 'namespace' <special_ident> '{' {<language_item>} '};'
<named_st_decl>          ::= 'named_st' <special_ident> ('{' [<optPrefix_type> {',' <optPrefix_type>}] '}')|[';']
<named_pt_decl>          ::= 'named_pt' <special_ident> ('{' [<object_decl: <optPrefix_type>> {',' <object_decl: <optPrefix_type>>}] '}')|[';']
<enum_decl>              ::= 'enum' <special_ident> ('{' <identifier>[<initializer] {',' <identifier>[<initializer]} '}')|[';']
<alias_decl>             ::= 'alias' <identifier> '=' ['namespace']<special_ident>|<prefix_type>
<function_decl>          ::= 'fn' <special_ident> '('[<func_param_list>]')' [<optPrefix_type>] <block>|[';']
******************************************************************************************************************************************************************************************************************************
...
<func_param_list>        ::= <object_decl> {',' <object_decl>}
<initializer>            ::= '::='<assignment_exp>|'('[<expArg_list>]')'
******************************************************************************************************************************************************************************************************************************
<block>                  ::= '{' {<block_item>} '}'
<block_item>             ::= <object_decl>[';']|<statement>|<named_pt_decl>|<named_st_decl>|<enum_decl>|<function_decl>|<alias>[';']|<label>[';']
...
<jump_statement>         ::= 'give'[<expression>]|('break'|'continue' ['('<integer_number_literal>')'])|('goto_label' ':' <identifier>)
<match_block>            ::= 'match'[<object_decl> ';'] <expression> [':' <identifier>] '{' {('case' <tal_encapsulation>|<expArg_list>)|'default ':' [<statement>]}  '}'
...
<prefix_exp>             ::= ('-'|'!'|'odd'|'++'|'--'|'$'|'&'|'mv'|'cp'|'mut_lref'|'imut_lref' <prefix_exp>)|<postfix_exp>
...
******************************************************************************************************************************************************************************************************************************
<reserved_exp_ident>     ::= ['::'] 'input'|'output'|'tcast'|'bcast'|'panic'|'none'|'nullptr' [<tal_encapsulation>]
<arg>                    ::= '#('[<expArg_list>]')'
...
namespace Nc
{
    ...
    private:
        void language();
        bool language_items(const FailureCase& fc = FailureCase{});
        bool namespace_decl(const FailureCase& fc = FailureCase{});
        bool named_st_decl(const FailureCase& fc = FailureCase{});
        bool named_pt_decl(const FailureCase& fc = FailureCase{});
        bool enum_decl(const FailureCase& fc = FailureCase{});
        bool alias_decl(const FailureCase& fc = FailureCase{});
        bool function_decl(const FailureCase& fc = FailureCase{});
      
        bool function_signature(const FailureCase& fc = FailureCase{});
        bool _typeof(const FailureCase& fc = FailureCase{});//c/c++ extention in vscode won't allow use 'typeof' which is werid
        bool optPrefix_type(const FailureCase& fc = FailureCase{});
        bool prefix_type(const FailureCase& fc = FailureCase{});
        bool func_param_list(const FailureCase& fc = FailureCase{});
        bool initializer(const FailureCase& fc = FailureCase{});

        bool block(const FailureCase& fc = FailureCase{});
        bool block_item(const FailureCase& fc = FailureCase{});
        bool object_decl(bool is_parsed_as_blockItem, bool should_parse_with_prefixType = true, const FailureCase& fc = FailureCase{});
        bool statement(const FailureCase& fc = FailureCase{});
        bool if_statement(const FailureCase& fc = FailureCase{});
        bool for_statement(const FailureCase& fc = FailureCase{});
        bool iter_statement(const FailureCase& fc = FailureCase{});
        bool while_statement(const FailureCase& fc = FailureCase{});
        bool do_while_statement(const FailureCase& fc = FailureCase{});
        bool jump_statement(const FailureCase& fc = FailureCase{});
        bool match_block(const FailureCase& fc = FailureCase{});

        bool identifier_list(const FailureCase& fc = FailureCase{});
        bool iterArg_list(const FailureCase& fc = FailureCase{});
        bool param_iterArg_assoc(const FailureCase& fc = FailureCase{});

        bool expression(const FailureCase& fc = FailureCase{});
        bool assignment_exp(const FailureCase& fc = FailureCase{});
        bool pipe_exp(const FailureCase& fc = FailureCase{});
        bool conditional_exp(const FailureCase& fc = FailureCase{});
        bool logical_exp(const FailureCase& fc = FailureCase{});
        bool equality_exp(const FailureCase& fc = FailureCase{});
        bool relational_exp(const FailureCase& fc = FailureCase{});
        bool shift_exp(const FailureCase& fc = FailureCase{});
        bool additive_exp(const FailureCase& fc = FailureCase{});
        bool multiplicative_exp(const FailureCase& fc = FailureCase{});
        bool exponention_exp(const FailureCase& fc = FailureCase{});
        bool member_exp(const FailureCase& fc = FailureCase{});
        bool prefix_exp(const FailureCase& fc = FailureCase{});
        bool postfix_exp(const FailureCase& fc = FailureCase{});
        bool primary_exp(const FailureCase& fc = FailureCase{});
        
        bool reserved_exp_ident(const FailureCase& fc = FailureCase{});
        bool arg(const FailureCase& fc = FailureCase{});
        bool fromType(const FailureCase& fc = FailureCase{});
        bool special_ident(const FailureCase& fc = FailureCase{});
        bool object_exp(const FailureCase& fc = FailureCase{});
        bool function_exp(const FailureCase& fc = FailureCase{});
        bool expArg_list(const FailureCase& fc = FailureCase{});
        bool param_expArg_assoc(const FailureCase& fc = FailureCase{});
        bool tal_encapsulation(const FailureCase& fc = FailureCase{});
        bool typeArg_list(const FailureCase& fc = FailureCase{});
        bool param_typeArg_assoc(const FailureCase& fc = FailureCase{});
        bool r_l(const FailureCase& fc = FailureCase{});
        bool r_l_arg_list(const FailureCase& fc = FailureCase{});
        bool param_r_l_arg_assoc(const FailureCase& fc = FailureCase{});
        ...
        bool expect(Lexer::TokenType tokenType, std::vector<U8string_view> tokenStr, const FailureCase& fc = FailureCase{});
